...
PYTHONPATH=../.. python ../../scripts/train/few_shot/run_train.py --data.dataset miniimagenet --data.root $HOME/data/miniimagenet --model.model_name "pairwise_conv" --log.exp_dir results/miniimagenet5-$TRAINLOSS --train-loss $TRAINLOSS --centroid-loss 0 --regularization 1 --iterations 100000 --data.way 5 --data.test_way 5 --data.cuda ${RELOAD_CMD}
