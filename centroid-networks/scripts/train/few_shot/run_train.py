...
parser.add_argument('--train-loss', required=True,
                    #choices=['softmax', 'sinkhorn', 'twostep', 'end2end', 'evalonly'],
                    help='meta-training loss')
...
if args['train_loss'] == 'evalonly':
    ...
    print('Reloading checkpoint {} for evaluation.'.format(args['checkpoint']))
